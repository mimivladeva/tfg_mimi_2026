...
#     nav2_yaml = os.path.join(get_package_share_directory('aidguide_04_provide_map'), 'param', 'nav2_param_robot_real.yaml')
#     map_file = os.path.join(get_package_share_directory('aidguide_04_provide_map'), 'map', 'aidguide_04_map.yaml')
#     rviz_config_dir = os.path.join(get_package_share_directory('aidguide_04_provide_map'), 'rviz', 'tb3_navigation2.rviz')
#     urdf_file = os.path.join(get_package_share_directory('aidguide_04_provide_map'), 'urdf', 'turtlebot3_burger.urdf')
