...
def generate_launch_description():
    ...
    params = os.path.join(pkg, 'config', 'nav2_param_sim.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='map_server',
            parameters=[params, {'yaml_filename': map_file}, {'use_sim_time': True}],
            output='screen'
        ),
        ...
        Node(
            ...
            name='bt_navigator',
            parameters=[params, {'use_sim_time': True}, {'default_nav_to_pose_bt_xml':'/opt/ros/jazzy/share/nav2_bt_navigator/behavior_trees/navigate_to_pose_w_replanning_and_recovery.xml'}],
            output='screen'
        ),
